...
const RegionalAssessment = () => {
  ...
  const items = [
    ...
    { key: "8", icon: <LeftCircleOutlined />, label: "Back to Sector and Service selection" },
  ];
            ...
            <p style={{ fontSize: "20px", lineHeight: "1.7", color: "#555" }}>
              ...
              {/* <a
                ...
                style={{
                  ...
                  textDecoration: "none",
                  fontWeight: "600",
                  borderBottom: "2px solid rgb(5, 119, 5)",
                  transition: "color 0.3s, border-bottom-color 0.3s",
                }}
                onMouseEnter={(e) => (e.target.style.color = "rgb(6, 187, 6)")}
                onMouseLeave={(e) => (e.target.style.color = "rgb(5, 155, 5)")}
              >
  ...
  return (
    <Layout className="regional-assessment" style={{ minHeight: "100vh" }}>
      ...
      footer={[
        ...
        Back to Sector and Service selection
      </Button>,
