...
export const proposalsDataTechnicalDeployment = [
    ...
    },
    {
        ...
        description:
          "A cost-effective alternative to fiber in areas where cable deployment is challenging. While less robust than fiber, microwave links offer faster, cheaper deployment. A hybrid approach, combining limited fiber with wireless backhaul, ensures quality connectivity while reducing costs.",
    },
    {
        key: "Scalable_Shareable_Solutions",
        title: "Scalable & Shareable Solutions",
        description:
          "Deploy scalable infrastructure that adapts to demand and tech advancements. Enable tower, backhaul, and resource sharing while using intelligent systems for service quality monitoring and optimization (e.g., service orchestration, dynamic radio configurations).",
    },
];
...
export const challengesDataServiceOfferingsandBusinessModels = [
    {
      ...
      description:
        "Sustaining regional high-speed connectivity is challenging due to high costs, low revenue, maintenance demands, and rapid technological changes. Environmental impacts and limited local expertise add complexity, requiring innovative and collaborative solutions.",
    },
    {
      key: "Lack_of_Tailored_Service_Offerings",
      title: "Lack of Tailored Service Offerings",
      description:
        "Service providers may not design packages or solutions tailored to the specific needs of rural communities, such as affordable low-data plans or agriculture-specific IoT services, leading to low adoption rates.",
    },
    {
      key: "Balancing_Public_and_Private_Interests",
      title: "Balancing Public and Private Interests",
      description:
        "Aligning the profitability goals of private operators with public objectives of digital inclusion and socio-economic development can be complex and lead to misaligned incentives.",
    },
];
