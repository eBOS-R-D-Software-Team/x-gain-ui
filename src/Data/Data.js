...
export const userTypes = [
    ...
    { id: 2, text: "Public Authority", checked: false, isActive: false, level_ids: [2, 3] , tooltip: "Choose this option if you are a government or municipal authority planning to improve  community- or regional-level infrastructure and connectivity."},
    { id: 3, text: "Internet Service Provider (ISP)", checked: false, isActive: false, level_ids: [2, 3], tooltip: "This option is for ISPs or network operators responsible for delivering connectivity services and planning infrastructure deployment." },
]
...
export const services = [
    ...
    { id: 11, text: "Government e-Services", checked: false, icon: "department.png", sectors_ids: [6] , tooltip: "Government eServices in rural environments are digital services provided by the government to rural residents. These can include various online services such as registration, applications, information dissemination, and more, designed to improve accessibility, reduce bureaucracy, and increase the efficiency of government services."},
